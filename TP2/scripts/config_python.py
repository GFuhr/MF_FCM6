...
FILE_LIST_H2D=['eule.c','clock.h','common.h','config_version.h','H2D.h','H2D_Func.h',
		...
		'init.c','step.c','functions.c','params.h','RK4.c'];
...
if __name__ == "__main__":
    ...
    make_test1=pyMake('make_gcc','h2d_gcc.exe','./','gcc',config_options,GCC_CFLAGS,GCC_LIB,FILE_LIST_H2D);
    make_test1.generate();
