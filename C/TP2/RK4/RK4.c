...
static void addRK4(double *const Up1, double const *const U, 
                    double const *const pUk1, double const *const pUk2, double const *const pUk3, double const *const pUk4, 
                    double const dDt, sFieldSize const *const sSize);
