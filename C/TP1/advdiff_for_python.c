...
int main(int argc, char **argv) {
    ...
    switch (choix1) {
        case 1:
            CreateMatrixDiffus(psp);
            break;
        case 2:
            CreateMatrixAdvec(psp);
            break;
        case 3:
            CreateMatrixAdvDiff(psp);
            break;
        default:
            break;
    }
...
int
advec(const double *const x, const double *const un, double *const unp1, const sParam *const psp, const double dFac) {
    unsigned int i;
    double tmp;
...
int
diffus(const double *const x, const double *const un, double *const unp1, const sParam *const psp, const double dFac) {
    unsigned int i;
...
int
advdif(const double *const x, const double *const un, double *const unp1, const sParam *const psp, const double dFac) {
...
int init_profiles(double *const x, double *const u0, const sParam *const psp, const pfProfInit pfpi) {
    unsigned int i;
...
int field_xpy(const double *const f1, const double *const f2, double *const fres, const unsigned int N) {
    unsigned int i;
...
int
field_xpby(const double *const f1, const double *const f2, double *const fres, const unsigned int N, const double dFac) {
    unsigned int i;
...
/*algorithme d'Euler */
int
resol_euler_expl(const double *const x, const double *const un, double *const unp1, const sParam *const psp, pfFuncOp pfop) {
    double *Utmp;
    Utmp = psp->Utmp;
...
/*algorithme de RK4 */
int
resol_rk4(const double *const x, const double *const un, double *const unp1, const sParam *const psp, pfFuncOp pfop) {
...
int initInvMat1D(const unsigned int iSizeX, const double *const a, const double *const b, const double *const c,
                 double *const pGam, double *const pBet) {
    unsigned int k = 0;
...
int invMat1D(const double *const pSrc, double *const pDest, const unsigned int iSizeX, const double *const a,
             const double *const pGam, const double *const pBet) {
    unsigned int k;
